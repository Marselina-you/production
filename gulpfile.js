...
const cheerio = require('gulp-cheerio');//манипулировать HTML и XML файлами с помощью cheerio.
const replace = require('gulp-replace');// позволяет заменять строки в файлах проекта с помощью регулярных выражений или простых поисковых запросов
const fileInclude = require('gulp-file-include');
const rev = require('gulp-rev');//полезный плагин для работы с ревизиями
const revRewrite = require('gulp-rev-rewrite');
const revDel = require('gulp-rev-delete-original');
const htmlmin = require('gulp-htmlmin');
const gulpif = require('gulp-if');// проверка на условия
const notify = require('gulp-notify');
const image = require('gulp-imagemin');
const {
  readFileSync
} = require('fs');
const typograf = require('gulp-typograf');//Готовьте тексты с помощью Typograf, используя Gulp.
const webp = require('gulp-webp');//Convert images to WebP
const mainSass = gulpSass(sass);
const webpackStream = require('webpack-stream');
const plumber = require('gulp-plumber');//водопроводчик" - позволяет обрабатывать ошибки, вместо падания всего скрипта.
